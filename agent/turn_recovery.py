...
from agent.retry_utils import is_zai_coding_overload_error, is_zai_coding_sustained_outage, zai_coding_overload_retry_ceiling
...
def compute_error_backoff(
    ...
    if _adaptive:
        ...
        if (
            (_backoff_policy or "").endswith("_long")
            or (_retry_after is not None and _retry_after > 60)
        ):
