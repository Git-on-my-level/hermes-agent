...
def _update_via_zip(args):
    ...
    # non-default update channel would be silently ignored, so refuse it.
...
def _cmd_update_check(
    ...
    *,
    ...
    checkouts still probe ``upstream/main`` first when that is the channel.
    """
...
def _cmd_update_impl(args, gateway_mode: bool):
    ...
    try:
        ...
        if remote_url.returncode != 0:
            ...
            print("  Add it, or set updates.remote to an existing remote.")
        ...
        if commit_count == 0:
            ...
            # Preserve stock fork sync behavior only for origin/main. A
            # configured deployment channel such as fork/prod is authoritative.
